---
layout: post
title: "Anapanasati for Enthusiastic Beginners (Part 5) Alan 6 3 24 21"
pubDate: 2021-03-24
author: Dhammarato
categories: [transcripts, Dhamma Talk]
tags: [transcripts, anapanasati, vedana, piti, sukkha, jhana, samadhi, sati, dukkha, anicca, sankhara, patticasamuppada, one-on-one, meditation, mindfulness, brahma-viharas, noble-eightfold-path, hindrances, wholesome-thoughts, unwholesome-thoughts, concentration, insight]
image: "https://i.ytimg.com/vi/wq5o8ii_dlc/maxresdefault.jpg"
description: "Transcript of March 24, 2021 Dhamma Talk with Dhammarato and Friends"
featured: false
hidden: false
toc: true
assemblyai_transcript_id: bf1b83cd-52ed-46ea-be30-5d73569d6411
---

## Anapanasati for Enthusiastic Beginners (Part 5) Alan 6 3 24 21

### Video


<p><iframe style="width:100%;" height="315" src="https://www.youtube.com/embed/wq5o8ii_dlc?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></p>
...
### **Core Topic: The Second Tetrad of Ānāpānasati (Mindfulness of Breathing)**
The discussion focuses on the **fifth and sixth trainings** (steps 5 & 6 of the 16-step practice), which involve cultivating **pīti** (joy/rapture) and **sukha** (happiness/pleasure).

### **Main Themes & Insights:**

**1. Two Kinds of Feelings (Vedanā):**
   *   **Foolish/Ignorant Feelings:** Conditioned by past habits (saṅkhāras) and misperceptions. They lead to craving, fear, anger, and suffering. We become "slaves" to them.
   *   **Wise Feelings:** Arise from present-moment understanding and mindfulness (*sati*). They lead to peace, safety, and contentment.
   *   **Key Mechanism:** Feelings arise not from the sense object itself, but from our **mental perception and labeling** of it (*nāmarūpa*). Wise practice involves "waking up" at this point of contact to choose a wholesome response.

**2. The Role of Thought in Meditation:**
   *   A critique is offered of methods (like some interpretations of the Mahasi "noting" technique) that aim only to stop **discursive thought**.
   *   **Dhammarato's Emphasis:** The crucial step is not to eliminate thought, but to **transform unwholesome discursive thoughts into wholesome ones**. This is the "herding" of the mind.
   *   **First Jhāna is characterized by this flow of wholesome thoughts** (e.g., "everything is okay," thoughts of goodwill) applied and sustained on an object. This builds the foundation for *pīti* and *sukha*.

**3. Understanding Pīti & Sukha:**
   *   **Pīti (Joy/Rapture):** Energetic, euphoric, exciting. Compared to the celebration after a sports touchdown. It can manifest as tingling, goosebumps, or energetic bodily sensations. It is **stimulating and can be agitating**.
   *   **Sukha (Happiness/Bliss):** Soothing, calm, contented, and peaceful. It is the satisfying feeling that follows the peak of *pīti*. **Sukha is presented as the direct opposite of *dukkha* (suffering)**.
   *   **Relationship:** They form a continuum. One cultivates *sukha* first, which can build into *pīti*, which then mellows back into deeper *sukha*. The goal is not to endlessly chase intense *pīti*, but to cultivate the **contentment and freedom from suffering** found in *sukha*.

**4. The Practical Goal: Mastering the First Jhāna**
   *   The ultimate aim for daily life is not the higher, thought-free jhānas, but **mastery of the First Jhāna**.
   *   **The Three Skills:**
     1.  **Entering** the first jhāna (establishing a stream of wholesome thoughts).
     2.  **Maintaining** it stably.
     3.  **Leaving it skillfully** (by gently creating gaps between wholesome thoughts, not by falling into hindrances).
   *   A life lived with the ability to maintain wholesome thoughts is a life free from doubt, fear, and anger—the essence of enlightenment in the world.

**5. Critique of Modern "Thrill-Seeking":**
   *   The discussion contrasts the wholesome *pīti* of meditation with the ignorant, addictive pursuit of external thrills (extreme sports, shopping, etc.).
   *   Worldly pleasures fade and become burdens (*dukkha*), leading to a cycle of compulsion. Meditative joy, understood wisely, leads to relaxation and release.

### **Conclusion:**
The talk provides a nuanced, practical guide to the middle stages of breath meditation. It shifts the focus from suppressing thought to cultivating wholesome mental patterns, clarifies the nature of meditative joy, and positions the First Jhāna not as a mere stepping stone, but as the primary, sustainable skill for a happy and free life. The foundation for all of this is an understanding of Dependent Origination (*Paṭiccasamuppāda*), explaining how feelings arise from perception.

### Metaphors and Stories

Based on the transcript, the speakers use several **metaphors, analogies, and stories** to explain complex Buddhist meditation concepts, particularly regarding feelings (*vedanā*), thoughts, and the stages of *ānāpānasati* (mindfulness of breathing). Here are the key ones:

### **Metaphors & Analogies:**

1.  **Feelings as Dictators/Slaves:**
    *   **Metaphor:** "The *Vedanā* are the master or dictators of our lives. When we are unable to control them, we become their slaves." This sets up the core struggle between wise and ignorant feelings.

2.  **The Mind as a Ship:**
    *   **Analogy:** Turning the mind from unwholesome to wholesome thought is compared to turning a large ship at sea. It's gradual; you can't stop it instantly, but you can change its direction.

3.  **Thoughts as Cows / The Cowherd Story:**
    *   **Story & Analogy:** This is a direct reference to a sutta (MN 19). Discursive thoughts are like cows. The meditator is the cowherd who must use a stick (mindful noting/effort) to keep the cows (thoughts) from wandering off the path (into unwholesome states) and damaging property (causing suffering). Once the cows are in a safe pasture (the mind is established in wholesome thoughts), the cowherd can relax.

4.  **Jhāna as a Ladder or High Wire:**
    *   **Analogy:** Developing the first *jhāna* is like learning to stand steadily on the first rung of a ladder or taking the first step onto a high wire. The skill is in finding stability there before attempting to "climb higher" (to deeper *jhānas*).

5.  **Piti & Sukha as a Wave:**
    *   **Metaphor:** *Piti* (joy/rapture) and *sukkha* (happiness/pleasure) are described as a wave. *Piti* is the peak (energetic, euphoric), and *sukkha* is the trough or baseline (calm, content). They are part of a continuous cycle.

6.  **Meditative Skill as Riding a Bicycle:**
    *   **Analogy:** Once you learn the "coordination and balance" of meditation (like riding a bike), you can return to it even after a long break, just as you can quickly regain balance on a bicycle after years.

7.  **Sensory Processing as "Mentalizing":**
    *   **Metaphor/Neologism:** Speaker B critiques the word "realize," suggesting "mentalize" is more accurate. We don't *realize* a tree (which would mean to make it real); we *mentalize* it—construct an internal representation based on past impressions (*saṅkhāras*).

### **Illustrative Stories & Examples:**

1.  **The Child Who Forgot Homework:**
    *   **Example:** A child on a school bus realizes they forgot their homework. An ignorant reaction is a cascade of anxious, unwholesome thoughts leading to panic. A wise reaction would be to assess realistically ("I can't get it now") and choose to enjoy the bus ride instead, cultivating wholesome feelings.

2.  **The Camper Hearing a Strange Sound:**
    *   **Example:** Waking up in the wilderness to an unknown sound. The ignorant feeling is immediate fear, fabricating stories (is it a wolf? a ghost?). The wise feeling is mindful curiosity—listening closely to discern what it actually is without preconceived fear.

3.  **Sports & Celebration Examples for Piti-Sukha:**
    *   **Football Touchdown:** The player's immediate spike of the ball and celebration is **Piti**. The fans' subsequent smiling, relaxed satisfaction as they watch the scoreboard is **Sukkha**.
    *   **New Year's Eve in Times Square:** The collective countdown and explosive cheer at midnight is **Piti**. The shift to hugging, swaying, and relaxed singing afterward is **Sukkha**.
    *   **The Star Player's Many Touchdowns:** Making a first touchdown brings strong *piti*. By the 28th touchdown, the feeling mellows into a more sustained *sukkha*—illustrating how repeated success changes the nature of the joyful feeling.

4.  **The Thrill-Seeker's Trap:**
    *   **Examples:** Various modern-life examples are used to illustrate ignorant *piti* and addiction to sensation: a Formula One racer chasing the thrill (dangerous, agitating), a shoplifter stealing for excitement, or someone constantly seeking new pleasures that eventually stop satisfying. This contrasts with the wholesome, calming *sukkha* developed in meditation.

5.  **The Model Train Set Hoarder:**
    *   **Example:** A man who built an elaborate model train set over thousands of hours. Once built, it required maintenance that became a burden, and the activity ceased to bring joy. This story illustrates how pleasurable pursuits can turn into sources of *dukkha* (suffering) when driven by ignorant craving and habit.

### **Core Conceptual Frameworks (which underpin the metaphors):**

*   **Two Kinds of Feelings:** The entire discussion is structured around the metaphor of **"wise feelings"** (born of present-moment understanding) vs. **"ignorant feelings"** (conditioned by past habits and reactions).
*   **Two Kinds of Thought:** Similarly, a key distinction is made between **unwholesome discursive thoughts** (hindrances) and **wholesome discursive thoughts** (which gladden the mind and are essential for the first *jhāna*).
*   **Jhāna as Progressive Relaxation:** The deepening *jhānas* are framed not just as states of concentration, but as **levels of progressive relaxation**—from the agitation of hindrances, to the calm of wholesome thought, to the stillness of no thought, and finally to profound equanimity.

In summary, the speakers use **relatable, modern analogies** (sports, vehicles, hobbies) and **classical Buddhist similes** (the cowherd) to demystify the internal process of meditation, highlighting the shift from being a slave to reactive, ignorant feelings to becoming a skilled master cultivating wise and wholesome states of mind.

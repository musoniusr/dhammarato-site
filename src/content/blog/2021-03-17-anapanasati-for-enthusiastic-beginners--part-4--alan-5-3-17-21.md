---
layout: post
title: "Anapanasati for Enthusiastic Beginners (Part 4) Alan 5 3 17 21"
pubDate: 2021-03-17
author: Dhammarato
categories: [transcripts, Dhamma Talk]
tags: [transcripts, anapanasati, vedana, piti, sukkha, jhana, samadhi, sati, dukkha, sankhara, vipassana, patticasamuppada, one-on-one, meditation, mindfulness, compassion, brahma-viharas, noble-eightfold-path]
image: "https://i.ytimg.com/vi/3_UBbht6uuE/maxresdefault.jpg"
description: "Transcript of March 17, 2021 Dhamma Talk with Dhammarato and Friends"
featured: false
hidden: false
toc: true
assemblyai_transcript_id: 2250c049-c069-4bcf-b9dd-b010613fde74
---

## Anapanasati for Enthusiastic Beginners (Part 4) Alan 5 3 17 21

### Video


<p><iframe style="width:100%;" height="315" src="https://www.youtube.com/embed/3_UBbht6uuE?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></p>
...
### **Core Theme:**
The discussion centers on **Anapanasati (mindfulness of breathing)**, specifically the fifth and sixth trainings concerning **Piti (joy/rapture) and Sukkha (happiness/pleasure)**, based on Bhikkhu Buddhadasa's teachings. The talk explores how to cultivate wise feelings and wholesome thoughts to achieve deeper states of concentration (Jhana).

### **Main Points:**

**1. Two Kinds of Feelings (Vedana):**
   * **Foolish/Ignorant Feelings:** Conditioned by past habits (samskaras) and misperceptions. They lead to craving, fear, anger, and suffering—essentially, we become "slaves" to them.
   * **Wise Feelings:** Arise from present-moment awareness and correct understanding. They lead to peace, safety, and contentment.
   * **Key Insight:** What "contacts" us is not the raw sensory input, but our **mental perception and labeling** of it (influenced by past karma). Mindfulness at this point of contact allows us to choose wise feelings.

**2. The Role of Thought in Meditation:**
   * Dhammarato critiques an incomplete understanding in some meditation methods (like the Mahasi noting technique). He emphasizes that the goal isn't just to replace **discursive thought** with **observational thought**.
   * A crucial, often missed step is transforming **unwholesome discursive thoughts** (hindrances like worry, doubt) into **wholesome discursive thoughts** (e.g., thoughts of goodwill, safety, "everything is okay").
   * This process of cultivating one wholesome thought after another **gladdens the mind**, creating the conditions for Piti and Sukkha to arise. It's compared to a cowherd gently guiding cows (thoughts) onto a harmless path.

**3. Understanding Piti and Sukkha:**
   * **Piti:** Energetic joy, rapture, or euphoria (e.g., the excitement after a touchdown). It is stimulating and can be physically felt (tingling, energy surges). While positive, it is still somewhat **agitating and coarse**.
   * **Sukkha:** Soothing happiness, contentment, and pleasure (e.g., the calm satisfaction after the celebration). It is more **peaceful and subtle**.
   * **Relationship:** They exist on a spectrum. Practice often starts with cultivating Sukkha (contentment), which can build into Piti (rapture), which then mellows back into a deeper Sukkha. Sukkha is emphasized as the **true antidote to suffering (Dukkha)**.

**4. Jhana as Progressive Relaxation:**
   * **First Jhana** is not about eliminating thought, but about mastering **wholesome, applied thought**. It is characterized by directed thought, evaluation, and the arising of Piti-Sukkha.
   * The ultimate practical goal is to become skilled at **entering, sustaining, and comfortably abiding in the First Jhana**. This state of sustained wholesome thought is a foundation for a happy life, free from hindrances.
   * Higher Jhanas (Second, Third, Fourth) are described as natural progressions of **deepening relaxation**: stilling discursive thought, then calming the joy, then moving toward equanimity.
   * A key warning: Seeking ever-stronger Piti or rushing to "no-thought" states (higher Jhanas) can be a trap. The stability and applicability of First Jhana for daily life are paramount.

**5. Practical Application & Warnings:**
   * **Addiction to Pleasure:** The modern compulsive pursuit of external pleasure was compared to an addiction, where one needs more stimulation for less reward. In contrast, the inner cultivation of Sukkha provides sustainable contentment.
   * **The "Skill" of Jhana:** The three skills are: (1) entering Jhana, (2) **maintaining it** (most important and often neglected), and (3) skillfully transitioning out of it (not just falling out into hindrances).
   * **Goal of Practice:** The aim is **freedom from suffering**, not just blissful states. A mind trained in sustained wholesome thought (First Jhana) is peaceful, secure, and capable of wise action in the world.

### **Conclusion:**
The talk provides a nuanced roadmap for Anapanasati, stressing the **interplay of perception, thought, and feeling**. The path involves using wise perception to generate wholesome thoughts, which in turn cultivate the joyful and happy feelings (Piti-Sukkha) that characterize the First Jhana. Mastery of this stable, wholesome, and contented state is presented as the essential foundation for both deeper meditation and a life free from suffering.

### Metaphors and Stories

Based on the transcript, the speakers use several **metaphors and stories** to explain complex Buddhist meditation concepts, primarily from the teachings of Bhikkhu Buddhadasa on *Anapanasati* (mindfulness with breathing). Here is a breakdown:

### **Metaphors**

1.  **Feelings as Masters or Dictators / Slavery Metaphor:**
    *   **Usage:** Speaker C quotes Buddhadasa: "the Vedana (feelings) are the master or dictators of our lives. When we are unable to control them, we become their slaves."
    *   **Purpose:** To illustrate the power of unexamined feelings and the lack of freedom that comes from being driven by them.

2.  **The Cowherd and the Cows (from Sutta 19):**
    *   **Usage:** Speaker B recounts this story from the suttas in detail.
    *   **Purpose:** To explain the management of discursive thoughts.
        *   **The Cows:** Represent discursive thoughts.
        *   **The Path:** Represents wholesome mental activity.
        *   **The Food Stalls/Children off the path:** Represent unwholesome or distracting thoughts.
        *   **The Cowherd's Stick:** Represents mindfulness or effort that "whacks" the mind back from unwholesome thoughts.
        *   **Cows Grazing Safely in the Harvested Field:** Represents the mind reaching a state where thoughts are consistently wholesome, allowing the "cowherd" (meditator) to relax.

3.  **Turning a Ship vs. Stopping It:**
    *   **Usage:** Speaker B uses this to contrast approaches to thought.
    *   **Purpose:** To argue that it's more practical to gradually turn the mind from unwholesome to wholesome thoughts (turning the ship) than to try to stop all thought immediately (stopping the ship dead in the ocean).

4.  **Getting a Child Ready for Bed:**
    *   **Usage:** "We've got to get the pajamas on the kid... before we can get him in bed."
    *   **Purpose:** To explain the sequential process of meditation: you must first guide the mind into wholesome states (first Jhana) before it can settle into deeper stillness (higher Jhanas).

5.  **Piti and Sukha as a Wave:**
    *   **Usage:** Speaker B uses a hand motion to show a wave peaking and troughing.
    *   **Purpose:** To illustrate the relationship between *piti* (joy/rapture) and *sukkha* (happiness/pleasure). *Piti* is the energetic peak (like a touchdown celebration), which then mellows into the calm, contented trough of *sukkha*.

6.  **Riding a Bicycle After Years:**
    *   **Usage:** Used in response to Speaker A's experience of being able to access *piti* sensations even after not formally practicing for years.
    *   **Purpose:** To explain that once a mental skill like generating wholesome joy is learned, the ability remains, just like muscle memory for bike riding.

7.  **The Ladder and the High Wire:**
    *   **Usage:** Used when discussing the "three skills" of Jhana.
    *   **Purpose:** To emphasize the importance of mastering the foundational step (first Jhana) before attempting to go further. You must be stable on the first rung of the ladder or the first step on the high wire before proceeding.

### **Stories / Anecdotal Examples**

1.  **The Child Who Forgot Homework:**
    *   **Usage:** Speaker B tells a story of a child on a school bus realizing they left their homework, spiraling into panic and anxiety.
    *   **Purpose:** To exemplify how a single unwholesome thought can trigger a cascade of associated unwholesome thoughts and painful feelings, and to contrast it with how a "wise" response would look.

2.  **Camping and Hearing a Strange Sound:**
    *   **Usage:** Speaker A offers this scenario of hearing an unknown sound in the wilderness at night.
    *   **Purpose:** To illustrate the moment of "ignorant feeling" (doubt, fear, confusion) versus "wise feeling" (curiosity, careful investigation).

3.  **Football Game Touchdown Celebration:**
    *   **Usage:** Speaker B uses the vivid example of a player and fans erupting in joy after a touchdown, then settling into happy contentment.
    *   **Purpose:** To provide a relatable, real-world analogy for the *piti* (energetic celebration) to *sukkha* (calm satisfaction) transition.

4.  **New Year's Eve in Times Square:**
    *   **Usage:** Similar to the football example, describing the countdown, the explosion of cheers at midnight (*piti*), and the subsequent hugging and swaying to music (*sukkha*).
    *   **Purpose:** To reinforce the *piti-sukkha* dynamic with another common cultural experience.

5.  **The Thrill-Seeking Examples (Formula One Racing, Motorcycles, Shoplifting):**
    *   **Usage:** Speaker B draws on personal and general examples of dangerous or intense activities done for the "thrill."
    *   **Purpose:** To distinguish worldly, agitation-based *piti* (which is often sought addictively) from the *piti* developed in meditation, and to show how a flow state (like that of a racer) resembles but is not the same as the second Jhana.

6.  **The Professor's Model Train Set:**
    *   **Usage:** A story about a hobby that eventually becomes a burdensome chore.
    *   **Purpose:** To exemplify David Foster Wallace's idea of the "supposedly fun thing"—how compulsive pursuit of pleasure can lead to suffering, mirroring the addictive quality of worldly *piti*.

**Overall Purpose:** These metaphors and stories serve to ground abstract Buddhist psychology (*citta, vedana, piti, sukha, jhana*) and meditation instructions in tangible, relatable experiences. They make the teachings on thought management, feeling cultivation, and the pitfalls of meditation progress much easier to understand and discuss.
